...
public class ImmutabilityTest {
     ...
     */
    private static final Set<String> IMMUTABLE_TYPES = Arrays.stream(new String[] {
        "java.lang.String",
        "java.lang.Integer",
        "java.lang.Byte",
        "java.lang.Character",
     ...
     */
    private static final Set<String> PRIMITIVE_TYPES = Arrays.stream(new String[] {
        "byte",
        "short",
        "int",
        "long",
     ...
     */
    private static final Set<String> ZERO_SIZE_ARRAY_FIELDS = Arrays.stream(new String[] {
     ...
     */
    private static final Set<String> SUPPRESSED_FIELDS_IN_MODULES = Arrays.stream(new String[] {
    ...
    private static final class ImmutableFieldArchCondition extends ArchCondition<JavaField> {
        /* package */ ImmutableFieldArchCondition() {
    ...
    private static final class ModulePropertyPredicate extends DescribedPredicate<JavaField> {
        ...
        /* package */ ModulePropertyPredicate() {
    ...
    private static final class ImmutableFieldsPredicate extends DescribedPredicate<JavaClass> {
        /* package */ ImmutableFieldsPredicate() {
    ...
    private static final class SuppressionArchCondition<T extends HasName.AndFullName>
        ...
        /* package */ SuppressionArchCondition(Set<String> suppressions, String description) {
            super(description);
